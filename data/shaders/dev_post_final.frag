...
uniform sampler2D tex_parallax_1;
uniform sampler2D tex_parallax_2;
uniform sampler2D tex_parallax_3;
uniform sampler2D tex_parallax_4;
uniform sampler2D tex_parallax_5;
uniform sampler2D tex_parallax_6;
uniform sampler2D tex_parallax_7;
uniform sampler2D tex_parallax_8;
uniform sampler2D tex_parallax_9;
uniform sampler2D tex_parallax_10;
uniform sampler2D tex_parallax_11;

uniform vec4 parallax_sky_color_1;
uniform vec4 parallax_sky_color_2;
uniform vec4 parallax_sky_color_3;
uniform vec4 parallax_sky_color_4;
uniform vec4 parallax_sky_color_5;
uniform vec4 parallax_sky_color_6;
uniform vec4 parallax_sky_color_7;
uniform vec4 parallax_sky_color_8;
uniform vec4 parallax_sky_color_9;
uniform vec4 parallax_sky_color_10;
uniform vec4 parallax_sky_color_11;

uniform vec4 parallax_alpha_color_1;
uniform vec4 parallax_alpha_color_2;
uniform vec4 parallax_alpha_color_3;
uniform vec4 parallax_alpha_color_4;
uniform vec4 parallax_alpha_color_5;
uniform vec4 parallax_alpha_color_6;
uniform vec4 parallax_alpha_color_7;
uniform vec4 parallax_alpha_color_8;
uniform vec4 parallax_alpha_color_9;
uniform vec4 parallax_alpha_color_10;
uniform vec4 parallax_alpha_color_11;

uniform vec4 parallax_1_1;
uniform vec4 parallax_1_2;
uniform vec4 parallax_1_3;
uniform vec4 parallax_1_4;
uniform vec4 parallax_1_5;
uniform vec4 parallax_2_1;
uniform vec4 parallax_2_2;
uniform vec4 parallax_2_3;
uniform vec4 parallax_2_4;
uniform vec4 parallax_2_5;
uniform vec4 parallax_3_1;
uniform vec4 parallax_3_2;
uniform vec4 parallax_3_3;
uniform vec4 parallax_3_4;
uniform vec4 parallax_3_5;
uniform vec4 parallax_4_1;
uniform vec4 parallax_4_2;
uniform vec4 parallax_4_3;
uniform vec4 parallax_4_4;
uniform vec4 parallax_4_5;
uniform vec4 parallax_5_1;
uniform vec4 parallax_5_2;
uniform vec4 parallax_5_3;
uniform vec4 parallax_5_4;
uniform vec4 parallax_5_5;
uniform vec4 parallax_6_1;
uniform vec4 parallax_6_2;
uniform vec4 parallax_6_3;
uniform vec4 parallax_6_4;
uniform vec4 parallax_6_5;
uniform vec4 parallax_7_1;
uniform vec4 parallax_7_2;
uniform vec4 parallax_7_3;
uniform vec4 parallax_7_4;
uniform vec4 parallax_7_5;
uniform vec4 parallax_8_1;
uniform vec4 parallax_8_2;
uniform vec4 parallax_8_3;
uniform vec4 parallax_8_4;
uniform vec4 parallax_8_5;
uniform vec4 parallax_9_1;
uniform vec4 parallax_9_2;
uniform vec4 parallax_9_3;
uniform vec4 parallax_9_4;
uniform vec4 parallax_9_5;
uniform vec4 parallax_10_1;
uniform vec4 parallax_10_2;
uniform vec4 parallax_10_3;
uniform vec4 parallax_10_4;
uniform vec4 parallax_10_5;
uniform vec4 parallax_11_1;
uniform vec4 parallax_11_2;
uniform vec4 parallax_11_3;
uniform vec4 parallax_11_4;
uniform vec4 parallax_11_5;
...
vec3 get_background_color(vec2 uv){
	...
	vec4 layer_1 = get_layer_color(uv, tex_parallax_1, parallax_1_1, parallax_1_2, parallax_1_3, parallax_1_4, parallax_sky_color_1, parallax_alpha_color_1);
	vec4 layer_2 = get_layer_color(uv, tex_parallax_2, parallax_2_1, parallax_2_2, parallax_2_3, parallax_2_4, parallax_sky_color_2, parallax_alpha_color_2);
	vec4 layer_3 = get_layer_color(uv, tex_parallax_3, parallax_3_1, parallax_3_2, parallax_3_3, parallax_3_4, parallax_sky_color_3, parallax_alpha_color_3);
	vec4 layer_4 = get_layer_color(uv, tex_parallax_4, parallax_4_1, parallax_4_2, parallax_4_3, parallax_4_4, parallax_sky_color_4, parallax_alpha_color_4);
	vec4 layer_5 = get_layer_color(uv, tex_parallax_5, parallax_5_1, parallax_5_2, parallax_5_3, parallax_5_4, parallax_sky_color_5, parallax_alpha_color_5);
	vec4 layer_6 = get_layer_color(uv, tex_parallax_6, parallax_6_1, parallax_6_2, parallax_6_3, parallax_6_4, parallax_sky_color_6, parallax_alpha_color_6);
	vec4 layer_7 = get_layer_color(uv, tex_parallax_7, parallax_7_1, parallax_7_2, parallax_7_3, parallax_7_4, parallax_sky_color_7, parallax_alpha_color_7);
	vec4 layer_8 = get_layer_color(uv, tex_parallax_8, parallax_8_1, parallax_8_2, parallax_8_3, parallax_8_4, parallax_sky_color_8, parallax_alpha_color_8);
	vec4 layer_9 = get_layer_color(uv, tex_parallax_9, parallax_9_1, parallax_9_2, parallax_9_3, parallax_9_4, parallax_sky_color_9, parallax_alpha_color_9);
	vec4 layer_10 = get_layer_color(uv, tex_parallax_10, parallax_10_1, parallax_10_2, parallax_10_3, parallax_10_4, parallax_sky_color_10, parallax_alpha_color_10);
	vec4 layer_11 = get_layer_color(uv, tex_parallax_11, parallax_11_1, parallax_11_2, parallax_11_3, parallax_11_4, parallax_sky_color_11, parallax_alpha_color_11);

	color = mix(color, layer_1.rgb, layer_1.a);
	color = mix(color, layer_2.rgb, layer_2.a);
	color = mix(color, layer_3.rgb, layer_3.a);
	color = mix(color, layer_4.rgb, layer_4.a);
	color = mix(color, layer_5.rgb, layer_5.a);
	color = mix(color, layer_6.rgb, layer_6.a);
	color = mix(color, layer_7.rgb, layer_7.a);
	color = mix(color, layer_8.rgb, layer_8.a);
	color = mix(color, layer_9.rgb, layer_9.a);
	color = mix(color, layer_10.rgb, layer_10.a);
	color = mix(color, layer_11.rgb, layer_11.a);
...
// liquid distortion/refraction effect (calculate distorted texture coordinates for later use) ===============
	...
	if (ENABLE_REFRACTION)
	{
   	...
   	vec2 pos_seed = vec2(camera_pos.x / SCREEN_W, camera_pos.y / SCREEN_H) + vec2( 0.0 );
...
// sample the original color =================================================================================
	...
	// if(tex_coord_.x > 0.5){
	// color    = texture2D(tex_bg, tex_coord).rgb;
	// } else {
	// color = get_background_color(tex_coord);
	// }
	...
	color = mix( color, get_background_color(doublevision_offset), 0.5 );
#endif
...
// output =====================================================================================================
	...
	//gl_FragColor.rgb = texture2D(tex_bg, tex_coord_).rgb;
